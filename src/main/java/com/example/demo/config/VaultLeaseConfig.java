...
public class VaultLeaseConfig {
	...
	private void updateDataSource(String username, String password) {
		TenantAwareDataSource tenantAwareDataSource = (TenantAwareDataSource) applicationContext.getBean("dataSource");
		HikariDataSource hikariDataSource = (HikariDataSource) tenantAwareDataSource.getTargetDataSource();
